...
tags: ['javascript', 'jscodeshift', 'ast']
keywords:
  ['javascript', 'jscodeshift', 'refactoring', 'ast', 'abstract syntax tree']
---
...
module.exports = (file, api) => {
  ...
  return j(file.source).find(j.DebuggerStatement).remove().toSource();
};
```
